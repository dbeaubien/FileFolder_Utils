...
If ($vt_monthFormatStr="mon")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "January"; "Jan")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "February"; "Feb")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "March"; "Mar")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "April"; "Apr")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "June"; "Jun")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "July"; "Jul")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "August"; "Aug")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "September"; "Sep")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "Sept"; "Sep")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "October"; "Oct")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "November"; "Nov")
	$vt_dateStr:=Replace string:C233($vt_dateStr; "December"; "Dev")
End if 
