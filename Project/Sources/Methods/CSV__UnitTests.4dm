...
Else 
	...
	Case of 
		...
		: ($action="CSV_LineFromFieldCollection")
			C_LONGINT:C283($n1; $n2)
			C_REAL:C285($r1; $r2)
			C_TEXT:C284($s1; $s2; $s3; $comma1; $cr1; $q1; $eol1; $eol2)
			C_DATE:C307($d1; $d2)
			C_TIME:C306($t1; $t2)
			C_BOOLEAN:C305($b1; $b2)
			C_OBJECT:C1216($o1)
			$n1:=1
			$n2:=2
			$r1:=2
		...
		: ($action="CSV_LineFromCollection")
			C_LONGINT:C283($n1; $n2)
			C_REAL:C285($r1; $r2)
			C_TEXT:C284($s1; $s2; $s3; $comma1; $cr1; $q1; $q2; $eol1; $eol2)
			C_DATE:C307($d1; $d2)
			C_TIME:C306($t1; $t2)
			C_BOOLEAN:C305($b1; $b2)
			C_OBJECT:C1216($o1)
