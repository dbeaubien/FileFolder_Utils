...
If (File_DoesExist($file_platformPath))
	...
	Else 
		var $msg : Text
		$msg:=Current method name:C684+": Failed to delete \""+$file_platformPath+"\" after 5 seconds of trying...\rCALL CHAIN: \r"+CallChain_FormatPretty(Get call chain:C1662)
	End if 
End if 
